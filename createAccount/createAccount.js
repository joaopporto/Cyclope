...
// personalInfo.addEventListener("click", (event) => {
//     event.preventDefault();
//     personalInfo.setAttribute("active", "");
//     addressInfo.removeAttribute("active");

//     document.querySelector('.personal-data').classList.remove('hide')
// });

// addressInfo.addEventListener("click", (event) => {
//     event.preventDefault();
//     addressInfo.setAttribute("active", "");
//     personalInfo.removeAttribute("active");
// });
